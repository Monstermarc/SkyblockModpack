...
recipes.addShaped(<ComputerCraft:CC-TurtleAdvanced>, [[<minecraft:diamond_sword>, <ore:chipsetGold>, <minecraft:diamond_axe>], [<Forestry:chipsets:3>, <IC2:upgradeModule>, <Forestry:chipsets:3>], [<minecraft:diamond_pickaxe>, <ThermalFoundation:material:135>, <minecraft:diamond_shovel>]]);
recipes.addShaped(<ComputerCraft:CC-Turtle>, [[<minecraft:diamond_sword>, <ore:chipsetIron>, <minecraft:diamond_axe>], [<Forestry:chipsets:3>, <IC2:upgradeModule>, <Forestry:chipsets:3>], [<minecraft:diamond_pickaxe>, <ThermalFoundation:material:135>, <minecraft:diamond_shovel>]]);
