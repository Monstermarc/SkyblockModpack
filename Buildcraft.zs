...
recipes.addShaped(<BuildCraft|Factory:pumpBlock>, [[<BuildCraft|Factory:tankBlock>, <ore:chipsetIron>, <BuildCraft|Factory:tankBlock>], [<ore:gearIron>, <IC2:blockMachine:8>, <ore:gearIron>], [null, <BuildCraft|Transport:item.buildcraftPipe.pipefluidsquartz>, null]]);
