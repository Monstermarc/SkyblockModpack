...
recipes.addShaped(<DraconicEvolution:energyInfuser>, [[<ore:blockEnderObsidian>, null, <ore:blockEnderObsidian>], [null, <minecraft:ender_pearl>, null], [<ExtraUtilities:decorativeBlock1:1>, <DraconicEvolution:draconium>, <ExtraUtilities:decorativeBlock1:1>]]);
...
//green heart
recipes.addShapeless(<TConstruct:heartCanister:5>, [<ForbiddenMagic:StarBlock>, <Metallurgy:fantasy.block:13>, <techreborn:techreborn.storage:14>, <ExtraUtilities:block_bedrockium>]);
