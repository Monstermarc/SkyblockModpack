...
recipes.addShaped(<Botania:alfheimPortal>, [[<ore:livingwood>, <Thaumcraft:ItemResource:15>, <ore:livingwood>], [<AWWayofTime:simpleCatalyst>, <ore:ingotTerrasteel>, <AWWayofTime:simpleCatalyst>], [<ore:livingwood>, <AWWayofTime:magicianBloodOrb>, <ore:livingwood>]]);

# -- Mana Lenses
recipes.remove(<Botania:lens>);
recipes.addShaped(<Botania:lens>, [[<ore:nuggetManasteel>, <ore:ingotManasteel>, <ore:nuggetManasteel>], [<ore:ingotManasteel>, <Botania:manaResource:1>, <ore:ingotManasteel>], [<ore:nuggetManasteel>, <ore:ingotManasteel>, <ore:nuggetManasteel>]]);
...
recipes.addShapeless(<Botania:manaResource:12>, [<ore:manaString>, <ore:elvenPixieDust>, <ore:bEnderAirBottle>, <ore:redstoneRoot>, <minecraft:redstone>, <Thaumcraft:ItemZombieBrain>]);
...
recipes.addShaped(<Botania:pylon:1>, [[<ore:nuggetManasteel>, <minecraft:ender_pearl>, <ore:nuggetManasteel>], [<ore:ingotTerrasteel>, <Botania:pylon>, <ore:ingotTerrasteel>], [<ore:nuggetManasteel>, <ore:pearlEnderEye>, <ore:nuggetManasteel>]]);
...
recipes.addShaped(<Botania:alchemyCatalyst>, [[<ore:livingrock>, null, <ore:livingrock>], [<AWWayofTime:blockWritingTable>, <Thaumcraft:ItemResource:14>, <AWWayofTime:blockWritingTable>], [<ore:livingrock>, <ore:blockBlaze>, <ore:livingrock>]]);
recipes.remove(<Botania:conjurationCatalyst>);
recipes.addShaped(<Botania:conjurationCatalyst>, [[<ore:livingrock>, <AWWayofTime:simpleCatalyst>, <ore:livingrock>], [<Botania:pylon:1>, <Botania:alchemyCatalyst>, <Botania:pylon:1>], [<ore:livingrock>, <AWWayofTime:simpleCatalyst>, <ore:livingrock>]]);
...
mods.botania.RuneAltar.addRecipe(<Botania:rune:4>, [<ore:runeWaterB>, <ore:runeFireB>, <minecraft:sapling:*>, <minecraft:sapling:*>, <minecraft:sapling:*>, <minecraft:wheat>, <AWWayofTime:imbuedSlate>], 4000);
...
recipes.addShaped(<Botania:travelBelt>, [[<ore:runeEarthB>, <harvestcraft:hardenedleatherItem>], [<harvestcraft:hardenedleatherItem>, <Thaumcraft:BootsTraveller>, <harvestcraft:hardenedleatherItem>], [<ore:ingotManasteel>, <harvestcraft:hardenedleatherItem>, <ore:runeAirB>]]);
