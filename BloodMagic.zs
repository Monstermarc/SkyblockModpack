...
recipes.addShaped(<AWWayofTime:Altar>, [[<Railcraft:machine.alpha:12>, <Botania:livingrock0Slab>, <Railcraft:machine.alpha:12>], [<Railcraft:machine.alpha:12>, <Thaumcraft:blockStoneDevice>, <Railcraft:machine.alpha:12>], [<ore:ingotManasteel>, <Botania:manaResource:2>, <ore:ingotManasteel>]]);
...
mods.botania.ElvenTrade.addRecipe(<AWWayofTime:blockPlinth>, [<AWWayofTime:blockPedestal>, <AWWayofTime:simpleCatalyst>, <AWWayofTime:blockPedestal>]);
...
mods.bloodmagic.BloodOrb.addShaped(<AWWayofTime:AlchemicalWizardrybloodRune>, [[<minecraft:stone>, <minecraft:flint>, <minecraft:stone>], [<AWWayofTime:blankSlate>, <AWWayofTime:weakBloodOrb>, <AWWayofTime:blankSlate>], [<minecraft:stone>, <Thaumcraft:ItemShard:*>, <minecraft:stone>]]);
...
mods.bloodmagic.Altar.addRecipe(<AWWayofTime:daggerOfSacrifice>, <ExtraTiC:knifeBlade:122>, 2, 2500);
...
recipes.addShaped(<AWWayofTime:itemRitualDiviner>, [[<ore:manaDiamond>, <AWWayofTime:airScribeTool>, <ore:manaDiamond>], [<AWWayofTime:waterScribeTool>, <AWWayofTime:fireScribeTool>, <AWWayofTime:fireScribeTool>], [<ore:manaDiamond>, <AWWayofTime:earthScribeTool>, <ore:manaDiamond>]]);

# -- Blood Letter's Pack
recipes.remove(<AWWayofTime:itemBloodPack>);
recipes.addShaped(<AWWayofTime:itemBloodPack>, [[<Botania:manaGlass>, <Thaumcraft:blockJar>, <Botania:manaGlass>], [<minecraft:flint>, <minecraft:leather_chestplate>, <minecraft:flint>], [<Botania:manaGlass>, <AWWayofTime:blankSlate>, <Botania:manaGlass>]]);

# -- Spell Crystals
mods.bloodmagic.Altar.removeRecipe(<AWWayofTime:blankSpell>);
mods.bloodmagic.Altar.addRecipe(<AWWayofTime:blankSpell>, <AWWayofTime:bloodMagicBaseItems:1>, 2, 1000);
mods.bloodmagic.Alchemy.removeRecipe(<AWWayofTime:itemComplexSpellCrystal>);
mods.bloodmagic.Alchemy.addRecipe(<AWWayofTime:itemComplexSpellCrystal>, [<AWWayofTime:blankSpell>, <AWWayofTime:weakBloodShard>, <AWWayofTime:weakBloodShard>, <Botania:manaResource:2>, <Botania:manaResource:1>], 3, 5000);
...
mods.bloodmagic.BloodOrb.addShaped(<AWWayofTime:growthSigil>, [[<Thaumcraft:blockCustomPlant>, <Botania:grassSeeds>, <minecraft:sapling>], [<Botania:grassSeeds:1>, <AWWayofTime:reinforcedSlate>, <Botania:grassSeeds:2>], [<minecraft:sapling:1>, <AWWayofTime:apprenticeBloodOrb>, <Thaumcraft:blockCustomPlant:1>]]);
