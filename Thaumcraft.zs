...
mods.botania.RuneAltar.addRecipe(<Thaumcraft:blockStoneDevice:2>, [<Thaumcraft:ItemShard:*>, <AWWayofTime:AlchemicalWizardrybloodRune>, <AWWayofTime:AlchemicalWizardrybloodRune>, <AWWayofTime:AlchemicalWizardrybloodRune>, <AWWayofTime:AlchemicalWizardrybloodRune>, <ore:runeWaterB>, <ore:runeFireB>, <ore:runeEarthB>, <ore:runeAirB>, <ore:runeManaB>], 1000000);
...
mods.thaumcraft.Arcane.addShaped("ENCHFABRIC", <Thaumcraft:ItemResource:7>, "aer 1, ignis 1, aqua 1, ordo 1, perditio 1, terra 1", [[null, <Botania:manaResource:16>], [<minecraft:string>, <minecraft:wool:*>, <minecraft:string>], [null, <Botania:manaResource:16>]]);
...
mods.thaumcraft.Arcane.addShaped("GOGGLES", <Thaumcraft:ItemGoggles>, "aer 5, ignis 5, aqua 5, terra 5, perditio 5, ordo 5", [[<harvestcraft:hardenedleatherItem>, <ore:ingotGold>, <harvestcraft:hardenedleatherItem>], [<harvestcraft:hardenedleatherItem>, null, <harvestcraft:hardenedleatherItem>], [<Thaumcraft:ItemThaumometer>, <ore:ingotGold>, <Thaumcraft:ItemThaumometer>]]);
...
mods.thaumcraft.Infusion.addRecipe("ARCANEBORE", <Thaumcraft:blockWoodenDevice:6>, [<AWWayofTime:bloodSocket>, <AWWayofTime:bloodSocket>, <Botania:manaResource:4>, <Botania:manaResource:4>, <AWWayofTime:boundPickaxe>, <AWWayofTime:boundShovel>, <Thaumcraft:ItemShard:3>, <AWWayofTime:earthScribeTool>], "perfodio 32, machina 32, potentia 16, vacuos 16, motus 16", <Thaumcraft:blockWoodenDevice:4>, 5);
