...
recipes.addShaped(<appliedenergistics2:tile.BlockController>, [[<ore:blockEnderium>, <Metallurgy:orichalcum.ingot>, <ore:blockPhasedGold>], [<appliedenergistics2:item.ItemMultiMaterial:23>, <AdvancedSolarPanel:asp_crafting_items:13>, <appliedenergistics2:item.ItemMultiMaterial:23>], [<ore:blockPhasedGold>, <Metallurgy:orichalcum.ingot>, <ore:blockEnderium>]]);
recipes.addShaped(<appliedenergistics2:tile.BlockEnergyAcceptor>, [[<ore:blockEnderium>, <Metallurgy:orichalcum.ingot>, <ore:blockPhasedGold>], [<appliedenergistics2:item.ItemMultiMaterial:24>, <AdvancedSolarPanel:asp_crafting_items:13>, <appliedenergistics2:item.ItemMultiMaterial:24>], [<ore:blockPhasedGold>, <Metallurgy:orichalcum.ingot>, <ore:blockEnderium>]]);
